import QtQuick 2.0
import "qrc:/qml/sub/onlinemusic/" as OnlineMusic
/***
* 在线音乐主界面
*/
Rectangle {
        ...
        Rectangle{
            ...
            VisualItemModel{
                ...
                Loader {
                    ...
                    source: "qrc:/qml/sub/onlinemusic/pageHot.qml";
                ...
                Loader {
                    ...
                    width: listPage.width;
                    height: listPage.height;
                    source: "qrc:/qml/sub/onlinemusic/pageSence.qml";
                    onLoaded: {
                ...
                Loader {
                    ...
                    width: listPage.width;
                    height: listPage.height;
                    source: "qrc:/qml/sub/onlinemusic/pageEmotion.qml";
                    onLoaded: {
                ...
                Loader {
                    ...
                    width: listPage.width;
                    height: listPage.height;
                    source: "qrc:/qml/sub/onlinemusic/pageStyle.qml";
                    onLoaded: {
                ...
                Loader {
                    ...
                    width: listPage.width;
                    height: listPage.height;
                    source: "qrc:/qml/sub/onlinemusic/pageYears.qml";
                    onLoaded: {
                ...
                Loader {
                    ...
                    width: listPage.width;
                    height: listPage.height;
                    source: "qrc:/qml/sub/onlinemusic/pageLanguage.qml";
                    onLoaded: {
        ...
        // 个人中心
        OnlineMusic.PagePersonalCenter{
